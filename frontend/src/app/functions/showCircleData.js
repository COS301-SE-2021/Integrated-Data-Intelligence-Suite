...
export function showCircleData(clicked_circle_class_name, json_data_from_backend) {
    ...
    const circle_obj_with_data = json_data_from_backend.find((x) => x.classname === clicked_circle_class_name);
    ...
    const clicked_circle_element = document.getElementsByClassName(clicked_circle_class_name);
