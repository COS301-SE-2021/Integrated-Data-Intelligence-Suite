...
public class parsingTest {
    ...
    public void testParsingImportedDataNUll(){
        //parsingServiceTest = new ParsingServiceImpl();
        Assertions.assertThrows(InvalidRequestException.class, ()->parsingServiceTest.parseImportedData(null));
    }
    ...
    public void testDataSourceNUll(){
        ...
        Assertions.assertThrows(InvalidRequestException.class, ()->parsingServiceTest.parseImportedData(request));
    }
    ...
    public void validparseImportedDataRequest() throws JSONException, InvalidRequestException {
        ...
        Assertions.assertNotNull(resp.getDataList());
    }
