...
public class ExtractorTest {
    ...
    public void testExtractorGetTextJsonStringNUll(){
        ...
        Assert.assertThrows(InvalidRequestException.class, ()->twitterExtractorTest.getText(testText));
    }
    ...
    public void testExtractorGetTextVaildJsonStringNUll() throws InvalidRequestException {
        ...
        Assert.assertNotNull(testresp.getText());
    }
    ...
    public void testExtractorGetDateRequestNUll(){
        //parsingServiceTest = new ParsingServiceImpl();
        Assert.assertThrows(InvalidRequestException.class, ()->twitterExtractorTest.getDate(null));
    }
    ...
    public void testExtractorGetDateJsonStringNUll(){
        ...
        Assert.assertThrows(InvalidRequestException.class, ()->twitterExtractorTest.getDate(testDate));
    }
