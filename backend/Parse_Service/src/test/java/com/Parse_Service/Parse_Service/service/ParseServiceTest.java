...
public class ParseServiceTest {
    ...
    public void parseImportedDataJsonStringNull() {
        ParseImportedDataRequest request = new ParseImportedDataRequest(DataSource.TWITTER, null, "", null);
    ...
    public void parseImportedDataMockTwitterData() throws Exception {
        ParseImportedDataRequest request = new ParseImportedDataRequest(DataSource.TWITTER, mockJsonData, "VIEWING", "Twitter");
